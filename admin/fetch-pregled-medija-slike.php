...
$query = "SELECT * FROM objava_slika WHERE obrisan=0";
...
$output = '<div style="padding-left:20px;"><label>Ukupno objava sa slikama: ' . $total_data . '</label></div>';
...
if ($total_filter_data > 0) {
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        <tr>
            ...
            <td class="align-middle text-center text-sm">
                <a href="brisanje-slike.php?id=' . $row['id'] . '" class="font-weight-bold" onclick="return confirm(\'Da li ste sigurni da želite obrisati ovu sliku?\');">
